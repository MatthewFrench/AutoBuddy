        ...
        public string GetDefaultSequence(Champion champ)
        {
            try
            {
                var ss = sequences.Split('\n').First(s =>
                    s.StartsWith(ObjectManager.Player.ChampionName));
                return ss.Substring(ss.IndexOf('=') + 1);
            }
            catch (Exception)
            {
                return "W;Q;W;E;W;R;W;Q;W;Q;R;Q;Q;E;E;R;E;E";
            }
        }
    }
}
